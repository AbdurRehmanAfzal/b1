(function ($) {
    ...
    function mainMap() {
      ...
      var mapZoomAttr = $("#map-2").attr("data-map-zoom");
      var mapScrollAttr = $("#map-2").attr("data-map-scroll");
      ...
      var map = new google.maps.Map(document.getElementById("map-2"), {
        zoom: zoomLevel,
        scrollwheel: false,
        center: new google.maps.LatLng(40.707370, -74.001643),
